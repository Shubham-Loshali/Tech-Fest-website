...
import text_img from "./nirvana-logo.svg";
...
const Hero = () => {
  ...
  // const startTimer = () => {
  //   const countdownDate = new Date("October 13 2025 18:00:00").getTime();
    ...
    <section id="home" className={classes.hero}>
      <div className={classes.herobox}>
        <div className={classes.headerbox}>
          {/* <h1 className={classes.heading}>Nirvana</h1> */}
          <img src={text_img} className={classes.text_img} alt="text_img" />

          <h4 className={classes.caption}>Lets make a tech move!</h4>
          <p className={classes.date}>October 17-18, 2025</p>
          <Link
